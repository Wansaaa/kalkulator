...
<body>
    ...
    <div class="container">
        <div class="kalkulator">
            ...
            </svg> Ichwan Sanusi</h2>
            <form method="post" action="index.php">
                <input type="number" name="bil1" class="bil" autocomplete="off" placeholder="Masukkan Bilangan Pertama" required>
            ...
            <div class="answer">
                <center>
                    ...
                    <?php }else{ ?>
                        <input type="number" disabled class="bil" value="0">
                        <?php } ?>
                </center>
            </div>
            <div class="footer">
                <p>&copy; copyright 2022 | <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
                ...
                </svg> by. <a href="https://www.instagram.com/Ichwan_sanusi/" target="_blank">Ichwan Sanusi</a></p>
            </div>  
        </div>
    </div>
